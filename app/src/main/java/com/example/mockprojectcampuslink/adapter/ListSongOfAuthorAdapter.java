...
public class ListSongOfAuthorAdapter extends RecyclerView.Adapter<ListSongOfAuthorAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            txtSongName = itemView.findViewById(R.id.listSongName);
            txtCountSong = itemView.findViewById(R.id.txtCountSong);
            linearLayout = itemView.findViewById(R.id.llSongOfAuthor);
