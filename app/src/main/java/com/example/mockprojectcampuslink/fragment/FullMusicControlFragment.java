...
public class FullMusicControlFragment extends Fragment implements OnBackPressFragment {
    ...
    private void initView(View view) {
        ...
        mImageButtonBack = view.findViewById(R.id.btnBack);
        mImageButtonNext = view.findViewById(R.id.imageButtonForward);
        mImageButtonPrevious = view.findViewById(R.id.imageButtonRewind);
        mTxtRunTime = view.findViewById(R.id.txtRunTime);
        mTxtFullTime = view.findViewById(R.id.txtFullTime);
        mSeekBar = view.findViewById(R.id.seekBar);
        mTxtSong = view.findViewById(R.id.txtSongInMC);
        mImageView = view.findViewById(R.id.imgSong);
        linearLayout = view.findViewById(R.id.layoutMusicControl);
    }
