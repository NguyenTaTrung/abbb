...
public class SortFragment extends BottomSheetDialogFragment {
    ...
    private void initView(View view) {
        ...
        mRadioButtonDefault = view.findViewById(R.id.radioButtonDefault);
        mRadioButtonAZ = view.findViewById(R.id.radioButtonAZ);
        mRadioButtonZA = view.findViewById(R.id.radioButtonZA);
