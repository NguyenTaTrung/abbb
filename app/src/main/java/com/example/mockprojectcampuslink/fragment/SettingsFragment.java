...
public class SettingsFragment extends BottomSheetDialogFragment {
    ...
    private void dialogPlaylist(){
        ...
        mBtnCreate = dialog.findViewById(R.id.btnCreate);
        mBtnCancle = dialog.findViewById(R.id.btnCancle);
    ...
    private void initView(View view) {
        mTxtAuthor = view.findViewById(R.id.txtViewAuthor);
        mTxtSong = view.findViewById(R.id.txtViewSong);
        mImageView = view.findViewById(R.id.imageSetting);
        mLinearLayout = view.findViewById(R.id.test);
        mImageBtnPlaylist = view.findViewById(R.id.imageBtnPlaylist);
        mImageBtnDelete = view.findViewById(R.id.imageBtnDelete);
        mRelativeLayoutPlayList = view.findViewById(R.id.relativeLayoutPlayList);
    }
